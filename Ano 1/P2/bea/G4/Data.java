...
public class Data {
	...
	public Data(int day, int month, int year) {
		assert (validDate(day, month, year));
	...
	/*public String toString() {
		return leadingZero(day) + day + "-" + leadingZero(month) + month 
				+ "-" + year; // assumes year > 1000
	}*/
	public int getDay() { 
		return day; 
	}
	...
	public boolean sameDate(Data data) {
		return((day == data.day) && (month == data.month) && (year == data.year));
	} 
	public boolean prevDate(Data data) {
	...
	public boolean afterDate(Data data) {
