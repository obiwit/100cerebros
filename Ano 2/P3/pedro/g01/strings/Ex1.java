...
public class Ex1 {
	 ...
	 * @param s
	 *            String to analyze
	 * @return a non-negative integer number representing the number of
	 *         occurrences of digits in the String.
	 */
	 ...
	 * @param s
	 *            String to analyze
	 * @return {@code true} if the string only has upper case characters, else
	 *         {@code false}
	 */
	 ...
	 * @param s
	 *            String to analyze
	 * @return {@code true} if the string only has low case characters, else
	 *         {@code false}
	 */
	...
	// Total of words
	/**
	 * Counts the number of words and prints the said words A word is considered
	 * to be splitted by spaces, \t or \n
	 */
	...
	public static String switchChars(String s) {
		...
		if (length % 2 != 0)
			n.append(s.charAt(length - 1)); // strings with an odd-length must
											// have the last char added
		return n.toString();
	}
}
