...
-- Equation(s):
-- \freqDiv|LessThan0~4_combout\ = (!\freqDiv|s_divCounter\(18) & (!\freqDiv|s_divCounter\(24) & !\freqDiv|s_divCounter\(16)))
...
-- Equation(s):
-- \freqDiv|clkOut~1_combout\ = (\freqDiv|s_divCounter\(0) & (\freqDiv|s_divCounter\(1) & (\freqDiv|s_divCounter\(2) & \freqDiv|s_divCounter\(3))))
...
-- Equation(s):
-- \freqDiv|LessThan0~0_combout\ = (!\freqDiv|s_divCounter\(18) & (!\freqDiv|s_divCounter\(11) & (!\freqDiv|s_divCounter\(24) & !\freqDiv|s_divCounter\(16))))
...
-- Equation(s):
-- \freqDiv|clkOut~3_combout\ = (\freqDiv|s_divCounter\(19) & (\freqDiv|s_divCounter\(22) & (\freqDiv|s_divCounter\(20) & \freqDiv|s_divCounter\(21))))
...
-- Equation(s):
-- \freqDiv|clkOut~5_combout\ = (!\freqDiv|s_divCounter\(15) & (\freqDiv|s_divCounter\(11) & (!\freqDiv|s_divCounter\(17) & \freqDiv|s_divCounter\(16))))
...
-- Equation(s):
-- \freqDiv|clkOut~7_combout\ = (\freqDiv|clkOut~4_combout\ & (\freqDiv|clkOut~6_combout\ & \freqDiv|clkOut~5_combout\))
...
PORT MAP (
	...
	datac => \freqDiv|LessThan0~6_combout\,
...
-- Equation(s):
-- \shifter|s_shiftReg[7]~9_combout\ = (\SW[11]~input_o\) # ((\SW[13]~input_o\ & ((\shifter|s_shiftReg\(7)))) # (!\SW[13]~input_o\ & (\SW[8]~input_o\)))
...
-- Equation(s):
-- \shifter|s_shiftReg~8_combout\ = (\SW[11]~input_o\ & (((\shifter|s_shiftReg\(7))))) # (!\SW[11]~input_o\ & (\SW[9]~input_o\ & ((!\SW[13]~input_o\))))
