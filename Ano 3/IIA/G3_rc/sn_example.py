...
# print(z.get_assoc_names())
# print(z.get_objects())
# print(z.get_users())
# print(z.get_types())
# print(z.get_local_assoc_names('homem'))
# print(z.get_user_decl_names('descartes'))
# print(z.get_user_decl_number('descartes'))
# print(z.get_entity_assocs_tuples('homem'))
