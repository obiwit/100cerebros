...
public class BicyclePolice extends Bicycle implements Police {
	 ...
	 * @param policeType
	 */
	public BicyclePolice(int year, String color, int numWheels, int maxSpeed, PoliceType policeType) {
	...
	public boolean equals(Object obj) {
		...
		BicyclePolice other = (BicyclePolice) obj;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
