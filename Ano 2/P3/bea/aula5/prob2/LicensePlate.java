...
public class LicensePlate {
	...
	public static boolean isValid(String licensePlate) {
		return  licensePlate.equalsIgnoreCase("Not Registered") || licensePlate.matches("\\d\\d-[A-Z][A-Z]-\\d\\d") || licensePlate.matches("\\d\\d-\\d\\d-[A-Z][A-Z]") || licensePlate.matches("[A-Z][A-Z]-\\d\\d-\\d\\d");
	}
