...
public class ImprovedKeyValueList<E>{
  ...
  private KeyValueNode<E> set(KeyValueNode<E> n, String k, E e) {
    ...
    else if(k.compareTo(n.key) > 0 || n.next == null ){
   ...
   */
	...
	private String toString(KeyValueNode<E> k, String mid){
		if(k.next==null)
			return "("+k.key+ "," + k.elem.toString()+")";
		else
			return"(" + k.key + "," + k.elem.toString() + ")"+ mid + toString(k.next, mid);
	}
