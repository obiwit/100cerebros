...
SIGNAL \shifter|s_data[1]~feeder_combout\ : std_logic;
SIGNAL \shifter|s_data[2]~feeder_combout\ : std_logic;
SIGNAL \shifter|s_data[3]~feeder_combout\ : std_logic;
SIGNAL \shifter|s_data[4]~feeder_combout\ : std_logic;
SIGNAL \shifter|s_data[5]~feeder_combout\ : std_logic;
SIGNAL \shifter|s_data[6]~feeder_combout\ : std_logic;
SIGNAL \shifter|s_data[7]~feeder_combout\ : std_logic;
SIGNAL \freqDiv|s_divCounter\ : std_logic_vector(25 DOWNTO 0);
SIGNAL \shifter|s_data\ : std_logic_vector(7 DOWNTO 0);
...
\shifter|s_data[1]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \shifter|s_data[1]~feeder_combout\ = \shifter|s_data\(0)
...
-- pragma translate_on
PORT MAP (
	datad => \shifter|s_data\(0),
	combout => \shifter|s_data[1]~feeder_combout\);

-- Location: FF_X88_Y72_N19
\shifter|s_data[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \shifter|s_data[1]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shifter|s_data\(1));

-- Location: LCCOMB_X88_Y72_N16
\shifter|s_data[2]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \shifter|s_data[2]~feeder_combout\ = \shifter|s_data\(1)
...
-- pragma translate_on
PORT MAP (
	datad => \shifter|s_data\(1),
	combout => \shifter|s_data[2]~feeder_combout\);

-- Location: FF_X88_Y72_N17
\shifter|s_data[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \shifter|s_data[2]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shifter|s_data\(2));

-- Location: LCCOMB_X88_Y72_N6
\shifter|s_data[3]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \shifter|s_data[3]~feeder_combout\ = \shifter|s_data\(2)
...
-- pragma translate_on
PORT MAP (
	datad => \shifter|s_data\(2),
	combout => \shifter|s_data[3]~feeder_combout\);

-- Location: FF_X88_Y72_N7
\shifter|s_data[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \shifter|s_data[3]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shifter|s_data\(3));

-- Location: LCCOMB_X88_Y72_N0
\shifter|s_data[4]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \shifter|s_data[4]~feeder_combout\ = \shifter|s_data\(3)
...
-- pragma translate_on
PORT MAP (
	datad => \shifter|s_data\(3),
	combout => \shifter|s_data[4]~feeder_combout\);

-- Location: FF_X88_Y72_N1
\shifter|s_data[4]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \shifter|s_data[4]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shifter|s_data\(4));

-- Location: LCCOMB_X88_Y72_N2
\shifter|s_data[5]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \shifter|s_data[5]~feeder_combout\ = \shifter|s_data\(4)
...
-- pragma translate_on
PORT MAP (
	datad => \shifter|s_data\(4),
	combout => \shifter|s_data[5]~feeder_combout\);

-- Location: FF_X88_Y72_N3
\shifter|s_data[5]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \shifter|s_data[5]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shifter|s_data\(5));

-- Location: LCCOMB_X88_Y72_N28
\shifter|s_data[6]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \shifter|s_data[6]~feeder_combout\ = \shifter|s_data\(5)
...
-- pragma translate_on
PORT MAP (
	datad => \shifter|s_data\(5),
	combout => \shifter|s_data[6]~feeder_combout\);

-- Location: FF_X88_Y72_N29
\shifter|s_data[6]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \shifter|s_data[6]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shifter|s_data\(6));

-- Location: LCCOMB_X88_Y72_N22
\shifter|s_data[7]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \shifter|s_data[7]~feeder_combout\ = \shifter|s_data\(6)
...
-- pragma translate_on
PORT MAP (
	datad => \shifter|s_data\(6),
	combout => \shifter|s_data[7]~feeder_combout\);

-- Location: FF_X88_Y72_N23
\shifter|s_data[7]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \freqDiv|clkOut~clkctrl_outclk\,
	d => \shifter|s_data[7]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shifter|s_data\(7));
