...
public class LinkedList<E> {
  ...
  private boolean contains(Node<E> n,E e) {
	  //~ out.println("e"+e);
	   //~ out.println("n.elem"+n.elem);
	  //~ out.println("equals(e)"+n.elem.equals(e));
  ...
  // funções adicionais pedidas no guião...
	...
	public LinkedList<E> concatenate(LinkedList<E> list){
		...
		return concatenate(this, list.first);
	}
	
	private LinkedList<E> concatenate(LinkedList<E> list, Node<E> n) {
		if (n != null){
			list.addLast(n.elem);
	...
	public void remove(E e){
		assert contains(e) : "elem not found";
