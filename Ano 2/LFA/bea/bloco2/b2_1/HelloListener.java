...
public interface HelloListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link HelloParser#valediction}.
	 * @param ctx the parse tree
	 */
	void enterValediction(HelloParser.ValedictionContext ctx);
	/**
	 * Exit a parse tree produced by {@link HelloParser#valediction}.
	 * @param ctx the parse tree
	 */
	void exitValediction(HelloParser.ValedictionContext ctx);
}