...
public class ImprovedKeyValueList<E> {
  ...
  /** {@code ImprovedKeyValueList} constructor.
   */
  public ImprovedKeyValueList() { }
  ...
  private KeyValueNode<E> set(KeyValueNode<E> n, String k, E e) {
    ...
    else if (n.next==null || (n.next.key.compareTo(k) > 0)) {
      n.next = new KeyValueNode<E>(k, e, n.next);
      size++;
    }
  ...
  public String toString(String start, String mid, String end) {
    ...
    else return start + toString(first, mid) + end + "\n";

  }
  private String toString(KeyValueNode<E> n, String mid) {
    if (n.next == null) return "(" + n.key + ", "+ n.elem.toString() + ")";
    else return "("+n.key+", "+n.elem.toString()+")" + mid + toString(n.next, mid);
  }
