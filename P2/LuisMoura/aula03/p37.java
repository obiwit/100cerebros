...
public class p37
{
  public static void main(String[] args)
  {
    ...
    out.println("\nAntes de introduzir divisoes: ");
    out.println("- Divisoes registadas: " + h.size());
    ...
    out.println("\nDepois de introduzir divisoes: ");
    out.println("- Divisoes registadas: " + h.size());
    out.println("- Capacidade actual  : " + h.maxSize());

    double avgDist = h.averageRoomDistance();
    out.println("\nDistancia media entre divisoes: "+avgDist);
    ...
    out.println("\nNumero de divisoes de cada tipo");
