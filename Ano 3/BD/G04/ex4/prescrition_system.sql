...
CREATE TABLE prescrition_system.Medico(
	No_identificacao	INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
	Especialidade		VARCHAR(30),
	Nome				VARCHAR(50)
);

CREATE TABLE prescrition_system.Paciente(
	No_utente			INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
...
CREATE TABLE prescrition_system.Prescricao(
	No_prescricao		INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
...
CREATE TABLE prescrition_system.Farmaceutica(
	Registo_farmaceutica	INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
