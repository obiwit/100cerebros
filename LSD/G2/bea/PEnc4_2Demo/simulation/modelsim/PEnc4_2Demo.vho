...
-- Equation(s):
-- \inst|encodedOut\(1) = (!\inst|comb~0_combout\ & ((\inst|encodedOut\(1)) # (!\inst|encodedOut[1]~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|encodedOut[1]~0_combout\,
...
-- Equation(s):
-- \inst|encodedOut\(0) = (!\inst|comb~1_combout\ & ((\inst|encodedOut\(0)) # (!\inst|comb~2_combout\)))
